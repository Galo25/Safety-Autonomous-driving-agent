...
from main import CarEnv, MEMORY_FRACTION


MODEL_PATH = 'models/Xception_____0.00max__-40.00avg_-200.00min__1594307146.model'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            # qs *= [0.975, 1, 0.92] # just a modification
            action = np.argmax(qs)
